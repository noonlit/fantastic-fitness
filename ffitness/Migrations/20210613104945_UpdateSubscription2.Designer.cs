...
namespace Ffitness.Migrations
{
    ...
    [Migration("20210613104945_UpdateSubscription2")]
    partial class UpdateSubscription2
    {
            ...
            modelBuilder.Entity("Ffitness.Models.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "d06349da-bb58-4ab4-93e2-80696c15ebcb",
                            ConcurrencyStamp = "f6000889-d62d-463f-a3fe-a45e190dd203",
                            Name = "User"
                        },
                        new
                        {
                            Id = "f5bcbc67-d8f3-4eb1-bfd9-0ca7e38da139",
                            ConcurrencyStamp = "e3888f9c-e148-4b27-8d85-fb181628d50f",
                            Name = "Admin"
                        });
                });
            ...
            modelBuilder.Entity("Ffitness.Models.Booking", b =>
                {
                    ...
                    b.HasOne("Ffitness.Models.Subscription", null)
                        .WithMany("Bookings")
